...
export default class ProductManager {
     ...
     * @param { { title: string, description: string, price: number, thumbnail, code: number, stock: number } } param0 
     */
    ...
    /**
     * @param {number} id
     * @param { { title: string, description: string, price: number, thumbnail, code: number, stock: number } } data
     */
